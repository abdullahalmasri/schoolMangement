...
public class config {
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception{
        http.cors().and().csrf().disable()
                ...
                .loginProcessingUrl("http://localhost:4200/api/v1/auth/home")
                .successForwardUrl("http://localhost:4200/api/v1/auth/home")
                .defaultSuccessUrl("http://localhost:4200/api/v1/auth/home", true)
                .permitAll().and()
